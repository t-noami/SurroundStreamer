...
const api = {
  ...
  openLogWindow: () => ipcRenderer.invoke('window:open-logs'),
  openAboutWindow: () => ipcRenderer.invoke('window:open-about'),
  openRepository: () => ipcRenderer.invoke('window:open-repository'),
